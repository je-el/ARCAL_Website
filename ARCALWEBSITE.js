...
function Home({ isDarkMode }) {
  return (
    <div className="min-h-screen p-6 flex flex-col items-center justify-center text-center">
      <h1 className="text-4xl font-bold mb-4">Welcome to ARCal</h1>
      ...
      <div className="flex gap-4">
        ...
        >
          <img
            ...
            src={isDarkMode ? "[path-to-white-ios-badge]" : "[path-to-black-ios-badge]"}
        ...
        >
          <img
            ...
            src={isDarkMode ? "[path-to-white-mac-badge]" : "[path-to-black-mac-badge]"}
